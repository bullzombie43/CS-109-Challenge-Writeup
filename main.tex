...
An interactive demo of the KDE-NB classifier is available at \url{https://cs109-deepfake-detector-j52u4q9yc-bullzombie43s-projects.vercel.app/}. It presents video frames one at a time and lets the user guess Real or Deepfake alongside the model, displaying the model's posterior probability $P(\text{fake} \mid \mathbf{x})$ after each round.
